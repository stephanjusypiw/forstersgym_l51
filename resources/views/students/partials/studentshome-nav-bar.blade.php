...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-collapse" id="navbar-main">
            ...
            <!-- show students menu option -->
            <ul class="nav navbar-nav">
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#" id="students">
                        Students
                        <b class="caret"></b></a>
                    <ul class="dropdown-menu" aria-labelledby="students">
                        <li><a href="{{ URL::to('student/create') }}">Add Student</a></li>
                    </ul>
                </li>
            </ul> <!-- end students menu option -->
